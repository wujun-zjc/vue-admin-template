  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column prop="pestName" align="center" label="虫害名称" width="180"></el-table-column>
...
export default {
  data() {
    return {
      ...
      rules: {
        pestName: [{ required: true, message: "虫害名称是必填项", trigger: "blur" }]
      }
    };
  },
  created() {
