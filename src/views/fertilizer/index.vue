  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column prop="type" align="center" label="肥量种类" width="180"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="农药种类" prop="type">
          <el-input :autosize="{ minRows: 2, maxRows: 4}" v-model="formData.type" type="text"/>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        type: [{ required: true, message: "肥料种类是必填项", trigger: "blur" }]
      }
    };
  },
  created() {
