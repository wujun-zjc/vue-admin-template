  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select
        ...
        class="filter-item"
      >
        <el-option v-for="item in operate" :key="item" :label="item" :value="item"/>
      </el-select>
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column prop="cropType" align="center" label="作物种类" width="220"></el-table-column>
        <el-table-column prop="Operator" label="操作人" align="center" width="180"></el-table-column>
        <el-table-column label="操作时间" prop="OperatorDate" align="center" width="180px">
...
export default {
  ...
  data() {
    return {
      ...
      cropType: ["number-1", "number-2", "number-3", "number-4", "number-5"],
      operate: ["number-1", "number-2", "number-3", "number-4", "number-5"],
       rules: {
        cropType: [
