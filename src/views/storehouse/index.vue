  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      <el-table
        ...
        style="width: 100%;"
      >
        <el-table-column type="index" lable="编号" width="50" align="center"></el-table-column>
        <el-table-column label="仓库编号" prop="id" align="center" width="90px"></el-table-column>
        <el-table-column label="仓库名称" prop="name" align="center" min-width="100px"></el-table-column>
        <el-table-column label="仓库地址" prop="adress" align="center" min-width="150px"></el-table-column>
        ...
        <el-table-column label="仓库描述" prop="description" align="center" min-width="150px"></el-table-column>
        <el-table-column label="仓库照片" align="center" width="150px">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="仓库地址" prop="adress">
          <el-input v-model="formData.adress" placeholder="请输入详细地址信息"/>
        </el-form-item>
        <el-form-item label="所属组织" prop="organization">
          <el-select v-model="formData.organization" class="filter-item" placeholder='请选择仓库所属组织'>
            <el-option v-for="item in organizations" :key="item" :label="item" :value="item"/>
          </el-select>
        </el-form-item>
        <el-form-item label="负责人" prop="charge">
          <el-select v-model="formData.charge" class="filter-item" placeholder='请选择基地负责人'>
            <el-option v-for="item in charges" :key="item" :label="item" :value="item"/>
          </el-select>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "仓库名称是必填项", trigger: "blur" }
        ],
      },
    };
  },
